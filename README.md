...
| Field | Rules / Requirements                              | Error Message                                                                                                                                                                                                |
|-------|---------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Level | Must be filled in, valid                          | -`"Level is required"` <br/>-`"Level cannot be empty"` <br/>-`"Level cannot exceed 50 characters"` <br/>-`"Invalid level"`                                                                                   |
| Name  | Must be filled in, 1–50 characters long           | -`"Name is required"` <br/>-`"Name cannot be empty"`<br/>- `"Name cannot exceed 50 characters"`                                                                                                              |
| Email | Must be filled in, valid email address and unique | -`"Teacher email is required"` <br/>-`"Teacher email cannot be empty"`<br/>- `"Teacher email cannot exceed 255 characters"` <br/>- `"Invalid teacher email"`<br/>-  `"Selected teacher already has a class"` |
